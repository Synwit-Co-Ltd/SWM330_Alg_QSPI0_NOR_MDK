...
** ELF Header Information
    ...
    Program header offset: 42912 (0x0000a7a0)
    Section header offset: 42976 (0x0000a7e0)
...
** Section #1 'PrgCode' (SHT_PROGBITS) [SHF_ALLOC + SHF_EXECINSTR]
    ...
    Verify
        ...
        0x00000180:    f1b26f00    ...o    CMP      r2,#0x8000000
    ...
    Read
        ...
        0x000001fa:    f1b36f00    ...o    CMP      r3,#0x8000000
...
** Section #4 'DevDscr' (SHT_PROGBITS) [SHF_ALLOC + SHF_EXECINSTR]
    ...
    FlashDevice
        ...
        0x000011c4:    3420524f    OR 4    DCD    874533455
        0x000011c8:    45545942    BYTE    DCD    1163155778
        0x000011cc:    44444120     ADD    DCD    1145323808
        0x000011d0:    00000052    R...    DCD    82
        ...
        0x0000123c:    08000000    ....    DCD    134217728
